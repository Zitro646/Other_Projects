namespace Mosframe
{
    ...
    public class DynamicVScrollViewQuitarInventario : DynamicScrollView
    {
        ...
        //Hemos sobreescrito este metodo para que establezca el tamaño maximo del Sroll View Al tamaño del Inventario del Investigador Jugable
        protected override void Start()
        {
            this.totalItemCount = objeto.GetComponent<ManejoFicheroDatos>().ObtenerTamañoMaximoInventarioJugador();
            base.Start();
        }

        //En este metodo comprobamos que el tamaño del Inventario del Investigador Jugable con el tamaño del Scroll View , si sale distinto reiniciamos el Scroll View
        public void Update()
        {
            int x = objeto.GetComponent<ManejoFicheroDatos>().ObtenerTamañoMaximoInventarioJugador();
