namespace Mosframe
{
    ...
    public class DynamicVScrollViewObjetos : DynamicScrollView
    {
        ...
        //Hemos sobreescrito este metodo para que establezca el tamaño maximo del Sroll View Al tamaño del Almacen de Objetos
        ...
        //En este metodo comprobamos que el tamaño del fichero de objetos con el tamaño del Scroll View , si sale distinto reiniciamos el Scroll View
        public void Update()
        {
